...
모델 준비:
    models/sensevoice/ 아래에 model.onnx(또는 model.int8.onnx) 와 tokens.txt 배치
    (예: sherpa-onnx-sense-voice-zh-en-ja-ko-yue-*)
"""
...
_HINT = (
    ...
    "  models/sensevoice/ 에 model.onnx(또는 model.int8.onnx) 와 tokens.txt 를 두세요.\n"
